...
//             <div className='text-[14px] font-normal mt-[9px] text-[#00000099] '>Enter your phone number, and we'll send you a code to reset your password.</div>
...
//                 </div>
//             </Link>
//             <Link href="/signin/resetpassword/phone/OTP">

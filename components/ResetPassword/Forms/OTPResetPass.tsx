...
const OTPResetPass = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.push('/signin/resetpassword/phone/newpassword');
    };
    ...
    return (
        <div>
            ...
            <div className='text-[14px] text-[rgba(0,0,0,0.6)] font-normal mt-[8px]'>
                We have sent an SMS with a code to <span className="font-bold">+372 5687413 </span>.
                Please enter the code below to verify your number.
            </div>
            <div className="text-[14px] font-normal text-[#00000059] mt-[8px] mb-[24px]">
                Resend code in 58s
            </div>

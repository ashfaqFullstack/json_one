...
function Herosection() {
    return (
        <div className="md:text-start text-center  text-[#171717] pb-4 md:px-0 px-4 ">
            <div className=" lg:text-[64px] md:text-[54px] sm:text-[40px] text-[38px] font-bold lg:mt-[196px] md:mt-[150px] mt-[120px] ">Launch Fast, Scale Big</div>
            <div className="lg:text-[39px] md:text-[29px] text-[25px] font-bold mt-[20px] md:mt-[31px]">Built for Africa, designed for growth.</div>

...
function Card() {
    return (
        <div className='mt-[120px] md:mt-[130px] lg:mt-[148px]' >
            ...
            <div className=' grid grid-cols-12 items-start text-[black] md:text-start text-center '>
                {/* first row of content  */}
                <div className=' md:col-span-4 col-span-12  lg:border-r border-[#e3dcdc] md:pr-[48px]  md:py-[149px] '>
                ...
                <div className='relative !self-center md:col-span-4 col-span-12 md:max-h-[40%] flex items-center border-l md:border-l-0 border-t border-b border-[#e3dcdc] my-[6%] md:my-0 py-[4%] md:py-[10%] md:px-[24px] md:mx-0 '>
